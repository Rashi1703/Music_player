...
statusbar = ttk.Label(root, text="Welcome to Music Player", anchor=W,font='Arial 20 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to Music Player", anchor=W, font='Arial 20 italic')
...
rtframe = Frame(root,bg="#ee6c4d")
rtframe.pack(pady=30,padx=20)
topframe = Frame(rtframe,bg="#ee6c4d")
topframe.pack()
root.style = ttk.Style()
root.style.configure('TLabel', background='#ee6c4d')
...
middleframe = Frame(rtframe,bg="#ee6c4d")
...
bottomframe = Frame(rtframe,bg="black")
